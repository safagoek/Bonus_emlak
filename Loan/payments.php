		...
		<div class="card">
			<div class="card-header">
				<large class="card-title">
					<b>Ödeme Listesi</b>
					<button class="btn btn-primary btn-sm btn-block col-md-2 float-right" type="button" id="new_payments"><i class="fa fa-plus"></i> Yeni Ödeme Ekle</button>
				</large>
				...
				<table class="table table-bordered" id="loan-list">
					...
					<thead>
						<tr>
							...
							<th class="text-center">Referans Numarası</th>
							<th class="text-center">Ödeyen</th>
							<th class="text-center">Miktar</th>
							<th class="text-center">Gecikme Cezası</th>
...
<script>
	...
	$('.delete_payment').click(function(){
		_conf("Bu Ödemeyi Silmek İstediğinize Emin Misiniz?","delete_payment",[$(this).attr('data-id')])
	})
function delete_payment($id){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					alert_toast("Ödeme Başarıyla Silindi",'success')
					setTimeout(function(){
						location.reload()
					},1500)
