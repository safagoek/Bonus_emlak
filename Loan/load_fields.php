...
<div class="row">
	<div class="col-md-5">
		<p><small>Aylık Miktar:<b><?php echo number_format($monthly,2) ?></b></small></p>
		<p><small>Gecikme Faizi :<b><?php echo $add = (date('Ymd',strtotime($next)) < date("Ymd") ) ?  $penalty : 0; ?></b></small></p>
		<p><small>Kalan Miktar :<b><?php echo number_format($monthly + $add,2) ?></b></small></p>
	</div>
	<div class="col-md-5">
		<div class="form-group">
